...
NOTE: You can also create a modules directory at the same level as
...
NOTE: If you are using the provided linux terminal, you can use the wget <URL> command to download the war.
