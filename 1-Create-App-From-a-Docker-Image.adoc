...
NOTE: The `--hostname` attribute in the command below is optional as we are using
...
NOTE: If you do not have the curl command on your machine you can simply visit the http://welcome.userXX.{{APPS_ADDRESS}}[URL] directly in a browser.
...
NAME      HOST/PORT                     PATH      SERVICE   LABELS
welcome   welcome.{{APPS_ADDRESS}}             welcome
