...
*Note:* If you cannot install the tools on your laptop and were just prefer
to start the labs right away, you can access an online terminal at {{WEB_TERMINAL_URL}}.
