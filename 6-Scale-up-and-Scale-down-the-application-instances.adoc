...
This shows that the build `time-1` is running in pod `45jtc` (note your pod will be named differently). Let us
...
the current replication controller for some reason, you will lose that
setting.
